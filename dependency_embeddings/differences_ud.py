...
if __name__ == '__main__':
    ...
    corpfiles = sorted([os.path.abspath(os.path.join(dirp, f)) for dirp, _, fn in os.walk('/Users/garrettsmith/Google Drive/UniPotsdam/Research/Features/dependency_embeddings/data/UD/') for f in fn if f.endswith('.txt')])
    ...
    fulldf.to_csv('/Users/garrettsmith/Desktop/CunningsSturtFeatMatchUD.csv', na_rep='NA')
